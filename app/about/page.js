    ...
    <>
      ...
      <main className={styles.page} style={{ position: 'relative', zIndex: 1 }}>
        ...
        <motion.section
          ...
          animate="show"
        >
          <motion.div className={styles.bioText} variants={fadeUp}>
          ...
          <motion.div className={styles.bioSide} variants={fadeUp}>
        ...
        >
          {Object.entries(skills).map(([cat, items]) => (
            <motion.div key={cat} className={styles.skillCol} variants={fadeUp}>
